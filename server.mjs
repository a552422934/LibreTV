...
function validateProxyAuth(req) {
  ...
  // 如果没有 auth，但请求的是常见图片等静态资源，则放行，避免无意义日志刷屏
  if (!authHash && targetUrl) {
    const isStaticResource = /\.(jpg|jpeg|png|gif|webp|bmp|svg|ico)(\?|$)/i.test(targetUrl);
    if (isStaticResource) {
      return true;
    }
  }
